...
public class Main {
    public static void main(String[] args) {
        ...
        OrderService service = new OrderService(repo, notifier, discount);
        ...
        OrderService vipService = new OrderService(repo, notifier, new VIPDiscount());
        vipService.createOrder("Carlos", "Monitor", 800, 2);
        
        System.out.println("\nPedidos en repositorio: " + repo.findAll().size());
    }
}